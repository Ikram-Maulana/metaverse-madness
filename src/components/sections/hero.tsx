      ...
      >
        ...
        >
          ...
          <Image
            src="/cover.png"
            alt="cover"
            className="w-full sm:h-[500px] h-[350px] object-cover rounded-tl-[140px] z-20 relative"
            width={1920}
            height={1080}
          />
          <Link href="#explore">
            <div className="w-full flex justify-end sm:-mt-[70px] -mt-[50px] pr-10 relative z-20">
              <Image
                src="/stamp.png"
                alt="stamp"
                width={100}
